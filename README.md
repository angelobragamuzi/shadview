...
OPERATIONAL_AGENT_DEFAULT_PASSWORD=SENHA_PADRAO_DO_AGENTE
```

`OPERATIONAL_AGENT_DEFAULT_PASSWORD` é opcional. Quando informado, o cadastro de agente usa essa senha fixa e envia a mesma no e-mail de credenciais.
